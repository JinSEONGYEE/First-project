              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-60 overflow-y-auto p-2 border rounded-md bg-gray-50">
                {links.map((link) => (
                  <button
                    ...
                    className={`w-full text-left p-3 border rounded-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-1 ${
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      {selectedLinks.includes(link.id) ? (
                        <CheckCircle aria-hidden="true" className="w-4 h-4 text-green-600 flex-shrink-0" />
                      ) : (
                        <Circle aria-hidden="true" className="w-4 h-4 text-gray-300 flex-shrink-0" />
                      )}
                    </div>
                  </button>
                ))}
