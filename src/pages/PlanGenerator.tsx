              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-60 overflow-y-auto p-2 border rounded-md bg-gray-50">
                {links.map((link) => (
                  <button
                    ...
                    className={`text-left w-full focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1 cursor-pointer p-3 border rounded-md transition-colors ${
